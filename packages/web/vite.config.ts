    ...
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
          ...
          // Precache the shell, not the entire editor and game code on the landing.
          globPatterns: ["**/*.{css,html,wasm}", "assets/index-*.js", "assets/Libs*.js"],
          ...
          runtimeCaching: [
            // Lazy chunks are cached only when the corresponding feature is opened.
            {
              urlPattern: /\/assets\/.+\.js$/i,
              handler: "CacheFirst",
              options: {
                cacheName: "app-script-cache",
