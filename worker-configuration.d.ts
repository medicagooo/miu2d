/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=D:\proj\miu2d\wrangler.types.local.json` (hash: bd2b6d170340eed4e5f4df176d12ebe0)
...
interface __BaseEnv_Env {
	...
	APP_URL: string;
	CORS_ORIGINS: string;
	AUTH_RATE_LIMIT: DurableObjectNamespace<import("./packages/server/src/worker").AuthRateLimit>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./packages/server/src/worker");
		durableNamespaces: "AuthRateLimit";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "SESSION_COOKIE_SECURE" | "S3_ENDPOINT" | "MINIO_ROOT_USER" | "MINIO_ROOT_PASSWORD" | "MINIO_BUCKET" | "S3_PUBLIC_ENDPOINT" | "APP_URL" | "CORS_ORIGINS">> {}
}
