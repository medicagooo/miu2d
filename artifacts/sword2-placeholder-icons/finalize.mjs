...
manifest.style = '以原始30×38白虹贯日、大力金刚掌、寒霜掌为参考，原作发光像素符号，生成图背景已转透明。首批写实插画弃用。';
